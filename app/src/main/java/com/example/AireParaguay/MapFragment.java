        ...
        protected void onPostExecute(Void aVoid) {
            ...
            for(int i = 0; i < regionList.size(); i++){
                ...
                if(aqiVal >= 0 && aqiVal <= 50){
                    ...
                    map.moveCamera(CameraUpdateFactory.newLatLngZoom(latLng,11.5f));
                }
            ...
            LatLng zoom = new LatLng(-25.287982, -57.58586);
            map.moveCamera(CameraUpdateFactory.newLatLngZoom(zoom, 11f));
